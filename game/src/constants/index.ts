...
export const INITIAL_PLAYER_HEALTH: Readonly<number> = 2023323223;
...
export const INITIAL_DIAGONAL_CHANCE: Readonly<PercentageType> = 0;
export const INITIAL_TOTAL_WAVES: Readonly<number> = 3;
export const INITIAL_WAVE_DELAY: Readonly<number> = 100; // ms
export const INITIAL_COUNT_WORDS_IN_WAVE: Readonly<number> = 4;
export const INITIAL_WORDS_SPEED: Readonly<number> = 150; // ms
